class CepsModel {
  ...
  CepsModel.fromListJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      ceps = <CepModel>[];
      json['results'].forEach((item) {
        ceps.add(CepModel.fromDatabaseJson(item));
      });
    }
  }
}
...
class CepModel {
  ...
  set objectId(String? siafi) => _objectId = objectId;
  ...
  CepModel.fromDatabaseJson(Map<String, dynamic> json) {
    _cep = json['cep_number'].toString();
    _logradouro = json['street'];
    _bairro = json['neighborhood'];
    _localidade = json['city'];
    _uf = json['state'];
